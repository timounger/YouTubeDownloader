...
if __name__ == "__main__":
    ...
    doxygen_creator.set_configuration("EXCLUDE_PATTERNS", exclude_pattern)
    file_pattern = [PYTHON_PATTERN, "*.md", "*.bat", "*.iss", "*.yml", "*.txt"]
    doxygen_creator.set_configuration("FILE_PATTERNS", file_pattern)
